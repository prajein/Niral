...
class _AffirmationsWidgetState extends State<AffirmationsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('AFFIRMATIONS_affirmations_ON_INIT_STATE');
      logFirebaseEvent('affirmations_update_page_state');
      setState(() {
        _model.affirmation = valueOrDefault<String>(
          functions.affirmationsLogic(),
          'You are Strong as Always',
        );
      });
    });
  }
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'AFFIRMATIONS_Container_9s41n6k3_ON_TAP');
                        logFirebaseEvent('Container_show_snack_bar');
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Affirmation is successfully said.',
                              style: TextStyle(
              ...
              child: Row(
                ...
                children: [
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'AFFIRMATIONS_keyboard_backspace_rounded_');
