                ...
                Row(
                  ...
                  children: [
                    RatingBar.builder(
                      ...
                      itemCount: 5,
                      itemSize: 45.0,
                      glowColor: FlutterFlowTheme.of(context).customColor2,
                    ),
                  ],
                ),
                Padding(
                    ...
                    children: [
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent('RATE_COMP_CANCEL_BTN_ON_TAP');
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('RATE_COMP_SEND_BTN_ON_TAP');
