        ...
        children: [
          Padding(
            ...
            child: InkWell(
              ...
              onTap: () async {
                logFirebaseEvent('RESOURCES_COMP_Container_z6s27g83_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '3ebbnggg' /* In case of Panic/Anxiety attac... */,
                          ),
          ...
          Padding(
            ...
            child: InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                logFirebaseEvent('RESOURCES_COMP_Container_y93bkqv0_ON_TAP');
                logFirebaseEvent('Container_navigate_to');
                    ...
                    children: [
                      Padding(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(10.0),
                          child: Image.asset(
                            'assets/images/24307396_6920933.jpg',
                            width: double.infinity,
                            height: 110.0,
                            fit: BoxFit.cover,
                          ),
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'xycih3bj' /* Helpful Resources and Guides */,
                          ),
                          textAlign: TextAlign.center,
                          style: FlutterFlowTheme.of(context)
                              .bodyLarge
