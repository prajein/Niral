...
class _UserProgressWidgetState extends State<UserProgressWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserProgressModel());
            ...
            children: [
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => Text(
                          '${valueOrDefault<String>(
                            valueOrDefault(currentUserDocument?.aouraPoints, 0)
                                .toString(),
                            '100',
                          )} / 100000',
              ...
              AuthUserStreamWidget(
                builder: (context) => CircularPercentIndicator(
                  percent: valueOrDefault(currentUserDocument?.aouraPoints, 0) /
                      100000,
                  radius: 50.0,
                  lineWidth: 8.0,
                  animation: true,
