...
class _CreateAccount4WidgetState extends State<CreateAccount4Widget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CreateAccount4'});
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'z51nunuc' /* Let's get started by filling o... */,
                                      ),
                                      textAlign: TextAlign.start,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge,
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'CREATE_ACCOUNT4_GET_STARTED_BTN_ON_TAP');
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'CREATE_ACCOUNT4_CONTINUE_WITH_GOOGLE_BTN');
                                              logFirebaseEvent('Button_auth');
                                              GoRouter.of(context)
                                                  .prepareAuthEvent();
                                              final user = await authManager
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CREATE_ACCOUNT4_RichText_k4blkqgf_ON_TAP');
                                          logFirebaseEvent(
                                              ...
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'kxrr19vn' /* Already have an account?   */,
                                                ),
                                                style: TextStyle(),
                                              ),
                                              TextSpan(
