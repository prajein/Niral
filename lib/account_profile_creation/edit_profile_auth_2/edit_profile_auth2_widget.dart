            ...
            child: AuthUserStreamWidget(
              builder: (context) => FlutterFlowDropDown<String>(
                ...
                options: [
                  ...
                  FFLocalizations.of(context).getText(
                    'wjes5nnw' /* Genderqueer */,
                  ),
                  FFLocalizations.of(context).getText(
                    'xg8sbpmo' /* Transgender */,
                  ),
                  FFLocalizations.of(context).getText(
                    'nuts2b5g' /* Prefer not to answer */,
                  )
                ],
              ...
              builder: (context) => FlutterFlowDropDown<String>(
                controller: _model.dropDownValueController2 ??=
                  ...
                  _model.dropDownValue2 ??= valueOrDefault<String>(
                    valueOrDefault(currentUserDocument?.ageInStr, ''),
                    '18',
                  ),
                ),
                options: [
          ...
          Padding(
            ...
            child: AuthUserStreamWidget(
              builder: (context) => TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: FFLocalizations.of(context).getText(
                    'smptln1t' /* Short Description */,
                  ),
                  labelStyle: FlutterFlowTheme.of(context).labelMedium,
                  hintText: FFLocalizations.of(context).getText(
                    'xewhkh3w' /* A little about you... */,
                  ),
                  hintStyle: FlutterFlowTheme.of(context).labelMedium,
                  errorStyle: FlutterFlowTheme.of(context).bodyMedium.override(
                        fontFamily:
                ...
                onPressed: () async {
                  ...
                  await currentUserReference!.update({
                    ...createUsersRecordData(
                      ...
                      ageInStr: _model.dropDownValue2,
                    ),
                    ...mapToFirestore(
                      {
                        'AouraPoints': FieldValue.increment(100),
                      },
                    ),
                  });
